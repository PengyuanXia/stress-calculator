...
export const TRANSLATIONS = {
  en: {
    ...
    btnModelMenu: 'Share / Save',
    shareMenuSub: 'URL link & QR code',
    saveMenuSub: 'Download .json file',
    loadMenuSub: 'Import .json file',
    btnSave: 'Save to File',
    btnLoad: 'Load from File',
    btnShare: 'Share Model',
    btnExport: 'Export PNG',
    btnPrint: 'Print Report',
    toastSaveSuccess: '💾 Model saved as JSON file.',
    toastLoadSuccess: '📂 Model loaded successfully!',
    toastLoadError: '❌ Invalid JSON file format.',
  ...
  pl: {
    ...
    btnModelMenu: 'Udostępnij / Plik',
    shareMenuSub: 'Link URL i kod QR',
    saveMenuSub: 'Pobierz plik .json',
    loadMenuSub: 'Wczytaj plik .json',
    btnSave: 'Zapisz do pliku',
    btnLoad: 'Wczytaj z pliku',
    btnShare: 'Udostępnij Model',
    btnExport: 'Eksportuj PNG',
    btnPrint: 'Drukuj Raport',
    toastSaveSuccess: '💾 Model zapisany jako plik JSON.',
    toastLoadSuccess: '📂 Model wczytany pomyślnie!',
    toastLoadError: '❌ Nieprawidłowy format pliku JSON.',
